...
This model, **AdaptivePathOptimizer-Speed**, is cloned from the previous model, **AdaptivePathOptimizer**. It enhances track alignment and speed control for improved performance.
## Action space
...
## Reward function
**AdaptivePathOptimizer-Speed** enhances **AdaptivePathOptimizer** by encourage the model to be faster and stay in the track.
```python
import math
...
## Hyperparameters 
Increase Gradient descent batch size.
