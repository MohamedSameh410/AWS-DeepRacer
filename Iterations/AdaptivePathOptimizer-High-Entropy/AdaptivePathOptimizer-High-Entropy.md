...
This model, **AdaptivePathOptimizer-High-Entropy**, is cloned from the previous model, **AdaptivePathOptimizer-Left-Speed**. It increases exploitation while minimizing exploration.
## Action space
